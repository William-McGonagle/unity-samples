...
class CSVObject
{
    ...
    /// <summary>
    /// Generic constructor for any CSVObject. Creates a new object from location on disk.
    /// </summary>
    /// <param name="path">The path to the stored CSVObject.</param>
    ...
    /// <summary>
    /// Saves the Object as a CSV File at a given path.
    /// </summary>
    ...
    /// <summary>
    /// Print the object in the CSV format.
    /// </summary>
    /// <returns>The printed object in CSV format.</returns>
    public string Print()
    {
